(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Rx'), require('@angular/common'), require('rxjs/Subject')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Rx', '@angular/common', 'rxjs/Subject'], factory) :
	(factory((global.ngxAppsLibrary = {}),global.ng.core,global.Rx,global.ng.common,global.Rx));
}(this, (function (exports,core,Rx,common,Subject$1) { 'use strict';
...
var UIToastComponent = (function () {
    function UIToastComponent(toastService) {
        ...
        this.toasts = [];
        this.destroyed$ = new Subject$1.Subject();
    }
    /**
     * @return {?}
     */
...
exports.Toast = Toast;
exports.UIToastModule = UIToastModule;
exports.ɵa = UIToastComponent;
